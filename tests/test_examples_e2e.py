...
class E2ETestSuite:
    ...
    def assert_detected(self, agent: Optional[Agent], test: TestResult, 
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        frameworks = {
            "LangChain Python": [r for r in self.results if "LangChain Python" in r.name],
            "LangChain TypeScript": [r for r in self.results if "LangChain TypeScript" in r.name],
