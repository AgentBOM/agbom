...
def example_basic_org_scan():
    ...
    scanner = Scanner(frameworks=["langchain-py", "langchain-ts", "autogen", "crewai"])
...
def example_filtered_by_language():
    ...
    bom = scanner.scan_org(
        org="your-org-name", use_search=True, search_languages=["Python"]
    )
...
def example_custom_keywords():
    ...
    bom = scanner.scan_org(
        org="your-org-name", use_search=True, search_keywords=custom_keywords
    )
...
def example_save_results():
    ...
    bom = scanner.scan_org(
        org="your-org-name", use_search=True, search_languages=["Python", "TypeScript"]
    )
